...
public class TestArme {
	public static void main(String[] args) {
		...
		// RESULAT :
		// Thomas est le premier à se joindre à la dernière bataille entre les Hommes et les dragons.
		// Le héros Arthur : Bonjour, je m'appelle Arthur et je viens me joindre au combat.
